...
methods, it can be programmed as a pure function that
...
A
[fragment]({{reactDocs}}/rendering-elements.html)
is such a mixture of
...
[component](#react-components)
is being
[rendered]({{reactDocs}}/react-component.html#render)
the
[constructor]({{reactDocs}}/react-component.html#constructor)
is the method
to construct the corresponding React class. It will set up the
[state](#state)
.
...
[component](#react-components)
is to act as a template to
be rendered. Its method
[render]({{reactDocs}}/react-component.html#render)
...
[notes.js]({{appBase}}/dux/notes.js)
,
the function `addItem()`. There, if
