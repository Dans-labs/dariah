...
*   `dispatch` **function**; this function belongs to the store that holds the
    ...
    [connect]({{reactRedux}}/docs/api.md#connectmapstatetoprops-mapdispatchtoprops-mergeprops-options)ing
...
These are object passed by [React-Router]({{reactRouter}}). From this the
