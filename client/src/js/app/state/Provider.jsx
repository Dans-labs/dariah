 ...
 * @class
 * @classdesc
 * **statefull, context providing** {@link external:Component|Component}
 *
 ...
 */
  constructor(props) {
    ...
    this.state = this.getWinDim()
  }
  getChildContext() {
    const { state: { ui }, globals } = this
    return { globals: { ...globals, ui} }
  }
  getWinDim = () => {
    const { innerHeight: height, innerWidth: width } = window
    return { ui: { height, width } }
  }
  render() {
