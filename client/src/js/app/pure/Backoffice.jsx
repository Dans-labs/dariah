...
const Backoffice = ({ children }) => (
  <div className={'backoffice'} >
    <div className={'nav bar'} >
      ...
      <p><NavLink to={`/backoffice/user/filter`} >{'Users (list)'}</NavLink></p>
      <p><NavLink to={`/backoffice/user/grid`} >{'Users (grid)'}</NavLink></p>
      <p><NavLink to={`/backoffice/country/filter`} >{'Countries (list)'}</NavLink></p>
      ...
      <p><NavLink to={`/backoffice/typeContribution/filter`} >{'Types (list)'}</NavLink></p>
      <p><NavLink to={`/backoffice/typeContribution/grid`} >{'Types (grid)'}</NavLink></p>
      <p><NavLink to={`/backoffice/criteria/filter`} >{'Criteria (list)'}</NavLink></p>
      <p><NavLink to={`/backoffice/criteria/grid`} >{'Criteria (grid)'}</NavLink></p>
      <p><NavLink to={`/backoffice/score/filter`} >{'Scores (list)'}</NavLink></p>
